...
pub(super) const RESULT_SCORE_BLOCK_OFFSET: usize = 0x28c;
pub(super) const RESULT_SCORE_BLOCK_WORDS: usize = 18;
pub(super) const RESULT_REWARD_BLOCK_OFFSET: usize = 0x328;
pub(super) const RESULT_REWARD_BLOCK_WORDS: usize = 7;
...
impl ResultStateSnapshot {
    pub(super) unsafe fn read(result_state: *const u8, max_events: usize) -> Option<Self> {
        ...
        let mut snapshot = Self {
            ...
            result_reward: read_u32_block::<RESULT_REWARD_BLOCK_WORDS>(
                result_state,
                RESULT_REWARD_BLOCK_OFFSET,
            ),
