...
fn render_rank_module() -> String {
    ...
    output.push_str("  export interface RankCalcMission {\n");
    output.push_str("    id?: number | null;\n");
    output.push_str("    mode?: string | null;\n");
    output.push_str("  }\n\n");
    output.push_str("  export interface RankCalcDifficulty {\n");
    output.push_str("    key?: string | null;\n");
    output.push_str("  }\n\n");
    output.push_str("  export interface RankCalcPlayer {\n");
    output.push_str("    active_character_ids: ReadonlyArray<string>;\n");
    output.push_str("  }\n\n");
    output.push_str("  export interface RankCalcContext {\n");
    output.push_str("    eventKey: string;\n");
    output.push_str("    payloadJson: string;\n");
    output.push_str("    mod: Oppw4ModContext;\n");
    output.push_str("    kind: \"count\" | \"time\";\n");
    output.push_str("    vanilla_rank?: RankGrade | null;\n");
    output.push_str("    count?: number | null;\n");
    output.push_str("    time_seconds?: number | null;\n");
    output.push_str("    mission: RankCalcMission;\n");
    output.push_str("    difficulty: RankCalcDifficulty;\n");
    output.push_str("    player: RankCalcPlayer;\n");
    output.push_str("  }\n\n");
