...
use plugin_sdk::{linkdata::LinkDataFile, OwnedHostApi, PluginResult, VirtualFileProvider};

use crate::log;

use super::with_registry;

pub(super) fn register(host: OwnedHostApi) -> PluginResult<()> {
    ...
    log::write_line("linkdata file provider registered");
    Ok(())
}
