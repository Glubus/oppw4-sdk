// Ghidra headless helper: export focused rank/result callsite targets.
//@category OPPW4
...
public class ExportRankCallsiteTargets extends GhidraScript {
    private static final String OUT =
        "C:/Users/Osef/Documents/Codex/oppw4-sdk-split/oppw4-sdk/docs/reverse-notes/rank-callsite-targets-2026-05-25.txt";
    ...
    private static final String[] CALLSITES = {
        "14132b8e9",
        "14132b8ee",
        "14132b912",
        "14132b917",
    ...
    protected void run() throws Exception {
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(out))) {
            pw.println("OPPW4.exe rank/result callsite targets");
            ...
            pw.println("CALLSITE WINDOWS");
            for (String address : CALLSITES) {
                dumpWindow(pw, address, 8, 10);
            }
