...
pub use plugin_abi::{
    HostActiveCharacterFn, HostGameStatusFn, HostPatchLinkDataRowFn, HostQuerySignalFn,
    HostRdbPatchReadFn, HostRegisterRdbPatchProviderFn, HostRegisterRdbVirtualProviderFn,
    HostReplaceLinkDataEntryFn, Oppw4ActiveCharacter, Oppw4FileProvider, Oppw4GameStatus,
    Oppw4LinkDataEntryPatch, Oppw4LinkDataRowPatch, Oppw4PluginApi, Oppw4ProviderCloseFn,
    ...
    Oppw4RegistryModuleInvokeFn, PluginModInfo, OPPW4_GAME_FLAG_DLC_CHARACTER_SEEN,
    OPPW4_GAME_FLAG_VIRTUAL_RESOURCE_SEEN, OPPW4_LINKDATA_ROW_OP_INSERT,
    OPPW4_LINKDATA_ROW_OP_REMOVE, OPPW4_LINKDATA_ROW_OP_REPLACE, OPPW4_PLUGIN_API_STRUCT_SIZE,
