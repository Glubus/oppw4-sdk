...
const result = target.replace_movesets("big_mom_temperamented_moveset.bin");

oppw4.trace("big_mom_temperamented_moveset.replace_movesets=" + JSON.stringify(result));